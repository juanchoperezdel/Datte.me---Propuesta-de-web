      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white/95 backdrop-blur-xl rounded-[2.5rem] p-10 text-left border border-white/20 shadow-2xl flex flex-col">
            ...
            <p className="text-slate-500 text-sm mb-8">Para profesionales que trabajan solos</p>
            <div className="mb-8">
              <span className="text-5xl font-extrabold text-slate-900">ARS $X</span>
            ...
            <p className="text-center text-xs text-slate-400 mt-4">Sin tarjeta de crédito</p>
          </div>
          ...
          <div className="bg-white rounded-[2.5rem] p-10 text-left border-4 border-indigo-200 shadow-2xl shadow-indigo-900/50 flex flex-col relative transform md:-translate-y-8 z-10">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-indigo-600 text-white px-4 py-1.5 rounded-full text-xs font-bold tracking-wide uppercase shadow-lg whitespace-nowrap">
              ⭐ Más elegido
            </div>
            <h3 className="text-2xl font-bold text-slate-900 mb-2">Negocio</h3>
            <p className="text-slate-500 text-sm mb-8">Para negocios con equipo</p>
            <div className="mb-8">
              <span className="text-5xl font-extrabold text-slate-900">ARS $Y</span>
              <span className="text-slate-500">/mes</span>
            </div>
            <ul className="space-y-4 mb-12 flex-1">
          ...
          <div className="bg-white/95 backdrop-blur-xl rounded-[2.5rem] p-10 text-left border border-white/20 shadow-2xl flex flex-col">
            ...
            <p className="text-slate-500 text-sm mb-8">Para cadenas y franquicias</p>
            <div className="mb-8">
              <span className="text-5xl font-extrabold text-slate-900">Consultar</span>
            </div>
            <ul className="space-y-4 mb-12 flex-1">
            ...
            <p className="text-center text-xs text-slate-400 mt-4">Personalizado</p>
          </div>
        </div>
        ...
        <div className="mt-20 max-w-3xl mx-auto bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-xl">
          ...
          <p className="text-indigo-100 text-lg">
            Si en 15 días no ves el valor, cancelás y listo. Sin preguntas, sin trámites.<br />
