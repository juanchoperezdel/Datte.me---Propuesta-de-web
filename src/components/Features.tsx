...
import { ArrowRight, Calendar, Clock, CreditCard, Shield, Smartphone, Zap } from 'lucide-react';
              ...
              {[
                {
                  ...
                  desc: "Los clientes pueden reservar turnos en cualquier momento, asegurando conveniencia sin largas llamadas o esperas."
                },
                {
                  icon: <Zap className="w-6 h-6 text-indigo-600" />,
                  title: "Recordatorios automáticos",
                  desc: "Alertas inteligentes por SMS y email reducen las ausencias y mantienen a clientes y profesionales a tiempo."
                },
                {
                  icon: <Shield className="w-6 h-6 text-indigo-600" />,
                  title: "Registros digitales seguros",
                  desc: "Todo el historial de clientes, prescripciones y reportes se guardan de forma segura y accesible en todo momento."
                },
                {
                  icon: <CreditCard className="w-6 h-6 text-indigo-600" />,
                  title: "Pagos y facturación simplificados",
                  desc: "Opciones de pago integradas y sistemas de facturación hacen las transacciones más rápidas y transparentes."
                }
              ].map((feature, i) => (
