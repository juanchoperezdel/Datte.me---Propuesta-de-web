    ...
    return (
        <div className="py-12 bg-white border-b border-slate-100">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <p className="text-center text-sm font-bold text-secondary/40 mb-8 uppercase tracking-widest">
                    Se integra con las herramientas que ya usás
                </p>
                <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
                    {/* Custom MercadoPago Logo */}
                    <div className="flex items-center gap-2 grayscale hover:grayscale-0 transition-all opacity-70 hover:opacity-100 h-10">
                        <img src="/logos/mercado-pago-manos.png" alt="Mercado Pago" className="h-8 w-auto object-contain" />
                        <span className="font-bold text-secondary text-lg tracking-tight">mercado<span className="text-blue-500">pago</span></span>
                    </div>
                    ...
                    <div className="flex items-center gap-2 grayscale hover:grayscale-0 transition-all opacity-70 hover:opacity-100">
                        ...
                        <span className="font-bold text-secondary text-lg tracking-tight">WhatsApp</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2 grayscale hover:grayscale-0 transition-all opacity-70 hover:opacity-100">
                        ...
                        <span className="font-bold text-secondary text-lg tracking-tight">Google Calendar</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2 grayscale hover:grayscale-0 transition-all opacity-70 hover:opacity-100">
                        <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 flex items-center justify-center p-[2px]">
                            <div className="w-full h-full bg-white rounded-[6px] flex items-center justify-center">
                                <svg className="w-5 h-5 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><rect width="18" height="18" x="3" y="3" rx="5" ry="5" strokeWidth="2"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" strokeWidth="2"></path><line x1="17.5" x2="17.51" y1="6.5" y2="6.5" strokeWidth="2"></line></svg>
                            </div>
                        </div>
                        <span className="font-bold text-secondary text-lg tracking-tight">Instagram</span>
                    </div>
                </div>
            </div>
        </div>
