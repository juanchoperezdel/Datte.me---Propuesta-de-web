            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="md:hidden flex bg-slate-100 rounded-xl p-1 mb-8 mx-auto w-full max-w-[280px]">
                    <button
                        ...
                        className={`flex-1 py-3 rounded-lg text-sm font-bold transition-all ${!showAfter ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
                    >
                        Sin datte.me
                    </button>
                    <button
                        onClick={() => setShowAfter(true)}
                        className={`flex-1 py-3 rounded-lg text-sm font-bold transition-all ${showAfter ? 'bg-indigo-600 text-white shadow-sm' : 'text-slate-500 hover:text-slate-700'}`}
                    >
                        Con datte.me
                    </button>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-8 lg:gap-12">
                    ...
                    {/* After */}
                    <div className={`${!showAfter ? 'hidden' : 'flex'} md:flex flex-1 flex-col bg-indigo-600 rounded-[2rem] p-8 md:p-10 text-white relative overflow-hidden shadow-2xl shadow-indigo-900/20 transform md:-translate-y-4`}>
