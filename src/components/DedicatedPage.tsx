            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div className="flex-1 text-center lg:text-left">
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white text-primary text-sm font-bold mb-8 border border-datte-purple-100 shadow-sm uppercase tracking-wider">
                        ...
                        <h2 className="text-4xl md:text-5xl font-extrabold text-dark mb-6 tracking-tight leading-tight">
                            ...
                            <span className="font-serif italic font-normal text-primary">página de reservas en segundos</span>
                        </h2>

                        <p className="text-xl text-secondary/80 mb-10 leading-relaxed">
                        ...
                        <ul className="space-y-4 mb-10 text-left w-fit mx-auto lg:mx-0">
                            {['Diseño optimizado para celulares', 'Tu logo y colores de marca', 'Listado de servicios y precios', 'Elección de profesional y horario'].map((item, i) => (
                                <li key={i} className="flex items-center gap-3 text-secondary/90 font-medium">
                        ...
                        <button className="w-full sm:w-auto px-8 py-4 bg-primary text-white rounded-full text-lg font-bold hover:bg-primary transition-all shadow-xl shadow-datte-purple-200 inline-flex items-center justify-center gap-2">
                    ...
                    <div className="flex-1 flex justify-center lg:justify-end relative">
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-datte-purple-200/50 rounded-full blur-3xl -z-10"></div>

                        <div className="w-[300px] h-[600px] bg-dark rounded-[3rem] p-3 shadow-2xl relative border-8 border-dark transform rotate-[-2deg] hover:rotate-0 transition-transform duration-500">
                            {/* Mobile Notch */}
                            ...
                            <div className="w-full h-full bg-white rounded-[2rem] overflow-hidden relative">
                                ...
                                <div className="pt-12 px-6 pb-6 bg-slate-50 h-full">
                                    <h4 className="text-xl font-bold text-dark mb-1">Estudio Mística</h4>
                                    <p className="text-sm text-secondary/60 mb-6">Peluquería & Estética en Palermo</p>

                                    <div className="space-y-3">
                                        <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100">
                                            <div className="flex items-center justify-between mb-2">
                                                <span className="font-bold text-dark">Corte de Pelo</span>
                                                <span className="font-bold text-primary">$8.000</span>
                                            </div>
                                            <p className="text-xs text-secondary/60 mb-3">45 min • Incluye lavado</p>
                                            <button className="w-full py-2 bg-datte-purple-100/50 text-primary rounded-xl text-sm font-bold">
                                                Elegir horario
                                            </button>
                                        </div>
                                        ...
                                        <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100">
                                            <div className="flex items-center justify-between mb-2">
                                                <span className="font-bold text-dark">Coloración</span>
                                                <span className="font-bold text-primary">$25.000</span>
                                            </div>
                                            <p className="text-xs text-secondary/60 mb-3">120 min • Con diagnóstico</p>
                                            <button className="w-full py-2 bg-datte-purple-100/50 text-primary rounded-xl text-sm font-bold">
                                                Elegir horario
                                            </button>
                                        </div>
